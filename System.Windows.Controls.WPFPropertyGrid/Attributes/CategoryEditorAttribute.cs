namespace System.Windows.Controls.WpfPropertyGrid.Attributes
{
  ...
  public sealed class CategoryEditorAttribute : Attribute
  {
    ...
    public CategoryEditorAttribute(string categoryName, string editorType)
    {
      ...
      this.CategoryName = categoryName.ToUpperInvariant();
    }
    ...
    {
      return this.EditorType.GetHashCode() ^ this.CategoryName.GetHashCode();
    }
    ...
    public override bool Equals(object obj)
    {
      ...
      return (attribute != null && attribute.EditorType == this.EditorType && attribute.CategoryName == this.CategoryName);
    }
  }
}
