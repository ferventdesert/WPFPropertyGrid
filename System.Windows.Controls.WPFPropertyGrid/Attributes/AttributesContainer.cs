...
namespace System.Windows.Controls.WpfPropertyGrid.Attributes
{
  ...
  public class AttributesContainer
  {
    ...
    public AttributesContainer(AttributeCollection attributes)
    {
      ...
      foreach (var type in from Attribute attr in this._attributes select attr.GetType())
        this.RegisterAttribute(type.Name, type);
    }
    ...
    public bool RegisterAttribute(string name, Type attributeType)
    {
      ...
      if (!this._keys.ContainsKey(attributeName))
      {
        this._keys.Add(attributeName, attributeType);
        return true;
      }
      return false;
    }
    ...
    public object this[string key]
    {
      get
      {
        ...
        {
          Type type;
          if (this._keys.TryGetValue(key, out type))
