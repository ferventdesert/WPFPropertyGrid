...
namespace System.Windows.Controls.WpfPropertyGrid
{
  ...
  public static class PropertyGridCommands
  {
    ...
    private static readonly RoutedUICommand _ShowFilter = new RoutedUICommand("Show LinkedPathFilter", "ShowFilter", ThisType);
    private static readonly RoutedUICommand _HideFilter = new RoutedUICommand("Hide LinkedPathFilter", "HideFilter", ThisType);
    private static readonly RoutedUICommand _ToggleFilter = new RoutedUICommand("Toggle LinkedPathFilter", "ToggleFilter", ThisType);
    private static readonly RoutedUICommand _ResetFilter = new RoutedUICommand("Reset LinkedPathFilter", "ResetFilter", ThisType);
